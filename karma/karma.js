...
const karma = async function (value, text, user_name, res_url, emoji) {
    ...
    'To ask for help, just type /karma help```';
		...
		sendText = '```--- NOT ALLOWED TO ADD/ DELETE MORE THAN 4 POINTS ---```';
		...
		sendText = '_To_ _check/add/delete_ karma _points_, _you_ _must_ _use_ \'@\' _before_ _a_ _user\'s_ _name_\n' +
  'Check the help section by typing */karma help*';
	} else {
		sendText = text + '\'s _karma_ has been updated to *' + value + '* by ' + user_name + ' ' + emoji;
	}
